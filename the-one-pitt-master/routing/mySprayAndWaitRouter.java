 ...
 * @author ASUS
 */
public class mySprayAndWaitRouter implements RoutingDecisionEngine {
    ...
    public mySprayAndWaitRouter(Settings s) {
        //super(s);
     ...
     */
    protected mySprayAndWaitRouter(mySprayAndWaitRouter r) {
        //super(r);
    ...
    public RoutingDecisionEngine replicate() {
        return new mySprayAndWaitRouter(this);
    }
